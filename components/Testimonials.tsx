    ...
    <section className="max-w-7xl sm:px-8 mx-auto px-6 py-24 relative z-10">
      ...
      <div className="flex flex-col sm:px-0 gap-x-6 gap-y-2">
        ...
        >
          ...
          <p className="text-xl sm:text-2xl text-black/60 leading-relaxed max-w-2xl font-geist tracking-tighter font-medium">
            Think of it as an in-house talent, without hiring, contracts, or
            agency headaches.sss
          </p>
        </div>
        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-sm font-medium text-black/40 font-geist">
